...
{
    public class ProductControllerTestWithInMemory : BaseTest
    {
        public ProductControllerTestWithInMemory()
        {
            SetContextOptions(new DbContextOptionsBuilder<ApiUnitTestDBContext>().UseInMemoryDatabase("ApiUnitTestDB").Options);
        }
